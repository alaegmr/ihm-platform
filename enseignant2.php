...
$correctPassword = "ihm"; // Remplacez cela par votre mot de passe réel

if (!isset($_POST['password']) || $_POST['password'] !== $correctPassword) {
    // Affichez le formulaire de mot de passe uniquement si le mot de passe n'est pas entré ou s'il est incorrect
    ...
    include 'confirm.php';
    exit; // Arrêtez l'exécution du reste du code
}
// Si le mot de passe est correct, poursuivez avec le reste de votre code
?>
<!DOCTYPE html>
<html lang="fr">
...
<head>
    ...
    <title>Plateforme Enseignante</title>
</head>
