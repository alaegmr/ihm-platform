...
<body>
    ...
    <header>
        <h1>Plateforme Etudiante</h1>
        <ul>
            <li id="profil"><a href="http://localhost/profilEtud.php"><i class="fa fa-user"></i>Profil</a></li>
        </ul>
    </header>
    ...
    <nav>
        <ul>
            ...
            <li><a href="http://localhost/etudiant.php" class="active" style="color: #FFF4A3;">Espace Etudiant</a></li>
            <li><a href="http://localhost/Q&A.php">Espace d'échanges</a></li>
        </ul>
    </nav>

    <section id="accueil">
        <h2 id="b">Bienvenue sur la Plateforme Etudiante</h2>
        <p id="p1"> Cette plateforme offre divers services aux étudiants</p>
        <p id="p2">Vous pouvez consulter les documents partagés par les enseignants chargé(e)s du module IHM</p>
    </section>
